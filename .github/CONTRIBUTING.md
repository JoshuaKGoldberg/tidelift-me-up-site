...
Thanks for your interest in contributing to `tidelift-me-up-site`! 💖
...
Please do [report an issue on the issue tracker](https://github.com/JoshuaKGoldberg/tidelift-me-up-site/issues/new/choose) if there's any bugfix, documentation improvement, or general enhancement you'd like to see in the repository! Please fully fill out all required fields in the most appropriate issue form.
